...
requires: [Core/Fx.Tween, Core/Fx.Morph, Core/Fx.Transitions, More/Assets, More/Slider, Element.Reflect, Fx.Value, Class.Settings]
		...
		this.master.images.each(function(el){
			...
			if(x>-foc*6 && x<foc*6){
				with (Math) {
					...
					div.top = round((oW * this.options.heightRatio * 0.8 - H)/2) + offY + 'px';
				}	
